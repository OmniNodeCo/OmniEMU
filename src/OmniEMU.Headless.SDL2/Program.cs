...
using OmniEMU.Common.GraphicsDriver;
using OmniEMU.Common.Logging;
using OmniEMU.Common.Logging.Targets;
...
using OmniEMU.Graphics.Gpu;
using OmniEMU.Graphics.Gpu.Shader;
using OmniEMU.Graphics.OpenGL;
using OmniEMU.Graphics.Vulkan;
using OmniEMU.Graphics.Vulkan.MoltenVK;
using OmniEMU.Headless.SDL2.OpenGL;
using OmniEMU.Headless.SDL2.Vulkan;
using OmniEMU.HLE;
...
namespace OmniEMU.Headless.SDL2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Title = $"OmniEMU Console {Version} (Headless SDL2)";
        ...
        static void Load(Options option)
        {
            ...
            _accountManager = new AccountManager(_libHacHorizonManager.OmniEMUClient, option.UserProfile);
            ...
            if (!option.DisableFileLog)
            {
                ...
                {
                    Logger.Error?.Print(LogClass.Application, "No writable log directory available. Make sure either the Logs directory, Application Data, or the OmniEMU directory is writable.");
                }
            }
