...
using OmniEMU.HLE.HOS.Applets;
using OmniEMU.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy.Types;
...
namespace OmniEMU.Headless.SDL2
{
    abstract partial class WindowBase : IHostUIHandler, IDisposable
    {
        ...
        {
            Stream iconStream = typeof(WindowBase).Assembly.GetManifestResourceStream("OmniEMU.Headless.SDL2.OmniEMU.bmp");
        ...
        private void InitializeWindow()
        {
            ...
            WindowHandle = SDL_CreateWindow($"OmniEMU {Program.Version}{titleNameSection}{titleVersionSection}{titleIdSection}{titleArchSection}", SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), Width, Height, DefaultFlags | FullscreenFlag | GetWindowFlags());
