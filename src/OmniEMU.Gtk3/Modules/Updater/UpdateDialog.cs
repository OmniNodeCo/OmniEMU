...
#pragma warning restore CS0649, IDE0044
        ...
        public UpdateDialog(MainWindow mainWindow, Version newVersion, string buildUrl) : this(new Builder("OmniEMU.Gtk3.Modules.Updater.UpdateDialog.glade"), mainWindow, newVersion, buildUrl) { }
        ...
        private UpdateDialog(Builder builder, MainWindow mainWindow, Version newVersion, string buildUrl) : base(builder.GetRawOwnedObject("UpdateDialog"))
        {
            ...
            Icon = new Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.Gtk3.UI.Common.Resources.Logo_OmniEMU.png");
            MainText.Text = "Do you want to update OmniEMU to the latest version?";
        ...
        private void YesButton_Clicked(object sender, EventArgs args)
        {
            if (_restartQuery)
            {
                string ryuName = OperatingSystem.IsWindows() ? "OmniEMU.exe" : "OmniEMU";
            ...
            else
            {
                ...
                Updater.UpdateOmniEMU(this, _buildUrl);
            }
        }
