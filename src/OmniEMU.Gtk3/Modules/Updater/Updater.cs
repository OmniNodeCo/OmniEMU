...
namespace OmniEMU.Modules
{
    public static class Updater
    {
                ...
                foreach (var asset in fetched.Assets)
                {
                    if (asset.Name.StartsWith("gtk-omniemu") && asset.Name.EndsWith(_platformExt))
                    {
                        ...
                        if (asset.State != "uploaded")
                        {
                            ...
                            {
                                GtkDialog.CreateUpdaterInfoDialog("You are already using the latest version of OmniEMU!", "");
                            }
        ...
        public static void UpdateOmniEMU(UpdateDialog updateDialog, string downloadUrl)
        {
...
#pragma warning restore SYSLIB0014
        ...
        private static async void InstallUpdate(UpdateDialog updateDialog, string updateFile)
        {
            ...
            updateDialog.SecondaryText.Text = "Do you want to restart OmniEMU now?";
        ...
        public static bool CanUpdate(bool showWarnings)
        {
            ...
            if (Program.Version.Contains("dirty") || !ReleaseInformation.IsValid)
            {
                if (showWarnings)
                {
                    GtkDialog.CreateWarningDialog("You cannot update a Dirty build of OmniEMU!", "Please download OmniEMU at https://github.com/OmniNodeCo/OmniEMU/ if you are looking for a supported version.");
                }
            ...
            if (showWarnings)
            {
                ...
                {
                    GtkDialog.CreateWarningDialog("Updater Disabled!", "Please update OmniEMU via FlatHub.");
                }
                else
                {
                    GtkDialog.CreateWarningDialog("Updater Disabled!", "Please download OmniEMU at https://github.com/OmniNodeCo/OmniEMU/ if you are looking for a supported version.");
                }
            }
