...
namespace OmniEMU.UI.Widgets
{
    internal class GtkDialog : MessageDialog
    {
        ...
        {
            new GtkDialog("OmniEMU - Info", mainText, secondaryText, MessageType.Info).Run();
        }

        internal static void CreateUpdaterInfoDialog(string mainText, string secondaryText)
        {
            new GtkDialog("OmniEMU - Updater", mainText, secondaryText, MessageType.Info).Run();
        }

        internal static MessageDialog CreateWaitingDialog(string mainText, string secondaryText)
        {
            return new GtkDialog("OmniEMU - Waiting", mainText, secondaryText, MessageType.Info, ButtonsType.None);
        }

        internal static void CreateWarningDialog(string mainText, string secondaryText)
        {
            new GtkDialog("OmniEMU - Warning", mainText, secondaryText, MessageType.Warning).Run();
        }
        ...
        internal static void CreateErrorDialog(string errorMessage)
        {
            ...
            new GtkDialog("OmniEMU - Error", "OmniEMU has encountered an error", errorMessage, MessageType.Error).Run();
        }

        internal static MessageDialog CreateConfirmationDialog(string mainText, string secondaryText = "")
        {
            return new GtkDialog("OmniEMU - Confirmation", mainText, secondaryText, MessageType.Question, ButtonsType.YesNo);
        }
        ...
        {
            return CreateChoiceDialog("OmniEMU - Exit", "Are you sure you want to close OmniEMU?", "All unsaved data will be lost!");
        }
    }
}
