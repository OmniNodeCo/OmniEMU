...
namespace OmniEMU.UI.Widgets
{
    ...
    {
        private const string SetupGuideUrl = "https://github.com/OmniNodeCo/OmniEMU#first-run";
        ...
        private static string GetErrorDescription(UserError error)
        {
            return error switch
            {
                UserError.NoKeys => "OmniEMU was unable to find your 'prod.keys' file",
                UserError.NoFirmware => "OmniEMU was unable to find any firmwares installed",
                UserError.FirmwareParsingFailed => "OmniEMU was unable to parse the provided firmware. This is usually caused by outdated keys.",
                UserError.ApplicationNotFound => "OmniEMU couldn't find a valid application at the given path.",
