...
namespace OmniEMU.UI.Windows
{
    public partial class UserProfilesManagerWindow : Window
    {
        ...
        public UserProfilesManagerWindow(AccountManager accountManager, ContentManager contentManager, VirtualFileSystem virtualFileSystem) : base($"OmniEMU {Program.Version} - Manage User Profiles")
        {
