...
namespace OmniEMU.UI.Windows
{
    public partial class AboutWindow : Window
    {
        ...
        private Image _omniemuLogo;
        private Box _logoTextBox;
        private Label _omniemuLabel;
        private Label _omniemuPhoneticLabel;
        private EventBox _omniemuLink;
        private Label _omniemuLinkLabel;
        ...
        private void InitializeComponent()
        {
            ...
            // _omniemuLogo
            //
            _omniemuLogo = new Image(new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.UI.Common.Resources.Logo_OmniEMU.png", 100, 100))
            {
                Margin = 10,
                MarginStart = 15,
            };
            ...
            // _omniemuLabel
            //
            _omniemuLabel = new Label("OmniEMU")
            {
                MarginTop = 15,
                Justify = Justification.Center,
                Attributes = new AttrList(),
            };
            _omniemuLabel.Attributes.Insert(new Pango.AttrScale(2.7f));

            //
            // _omniemuPhoneticLabel
            //
            _omniemuPhoneticLabel = new Label("(REE-YOU-JINX)")
            {
                Justify = Justification.Center,
            };
            ...
            // _omniemuLink
            //
            _omniemuLink = new EventBox()
            {
                Margin = 5
            };
            _omniemuLink.ButtonPressEvent += OmniEMUButton_Pressed;

            //
            // _omniemuLinkLabel
            //
            _omniemuLinkLabel = new Label("github.com/OmniNodeCo/OmniEMU")
            {
                TooltipText = "Click to open the OmniEMU website in your default browser.",
                Justify = Justification.Center,
                Attributes = new AttrList(),
            };
            _omniemuLinkLabel.Attributes.Insert(new Pango.AttrUnderline(Underline.Single));
            ...
            // _disclaimerLabel
            //
            _disclaimerLabel = new Label("OmniEMU is not affiliated with Nintendo™,\nor any of its partners, in any way.")
            {
                Expand = true,
                Justify = Justification.Center,
                Margin = 5,
            ...
            {
                TooltipText = "Click to open the OmniEMU Patreon page in your default browser.",
            };
            ...
            // _patreonLogo
            //
            _patreonLogo = new Image(new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.UI.Common.Resources.Logo_Patreon_Light.png", 30, 30))
            {
                Margin = 10,
            };
            ...
            {
                TooltipText = "Click to open the OmniEMU GitHub page in your default browser.",
            };
            ...
            // _githubLogo
            //
            _githubLogo = new Image(new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.UI.Common.Resources.Logo_GitHub_Light.png", 30, 30))
            {
                Margin = 10,
            };
            ...
            {
                TooltipText = "Click to open an invite to the OmniEMU Discord server in your default browser.",
            };
            ...
            // _discordLogo
            //
            _discordLogo = new Image(new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.UI.Common.Resources.Logo_Discord_Light.png", 30, 30))
            {
                Margin = 10,
            };
            ...
            {
                TooltipText = "Click to open the OmniEMU Twitter page in your default browser.",
            };
            ...
            // _twitterLogo
            //
            _twitterLogo = new Image(new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.UI.Common.Resources.Logo_Twitter_Light.png", 30, 30))
            {
                Margin = 10,
            };
            ...
            //
            _aboutDescriptionLabel = new Label("OmniEMU is an emulator for the Nintendo Switch™.\n" +
        ...
        {
            _logoBox.Add(_omniemuLogo);

            _omniemuLink.Add(_omniemuLinkLabel);

            _logoTextBox.Add(_omniemuLabel);
            _logoTextBox.Add(_omniemuPhoneticLabel);
            _logoTextBox.Add(_omniemuLink);
