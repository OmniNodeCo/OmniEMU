...
namespace OmniEMU.UI.Windows
{
    public partial class AmiiboWindow : Window
    {
        ...
        public AmiiboWindow() : base($"OmniEMU {Program.Version} - Amiibo")
        {
            Icon = new Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "OmniEMU.UI.Common.Resources.Logo_OmniEMU.png");
            ...
            _amiiboLogoBytes = EmbeddedResources.Read("OmniEMU.UI.Common/Resources/Logo_Amiibo.png");
