...
using OmniEMU.UI.Common.SystemInfo;
...
namespace OmniEMU
{
    partial class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                MessageBoxA(IntPtr.Zero, "You are running an outdated version of Windows.\n\nOmniEMU supports Windows 10 version 1803 and newer.\n", $"OmniEMU {Version}", MbIconWarning);
            }
            ...
            Console.Title = $"OmniEMU Console {Version}";
                ...
                if (LinuxHelper.VmMaxMapCount < LinuxHelper.RecommendedVmMaxMapCount)
                {
                    ...
                    if (LinuxHelper.PkExecPath is not null)
                    {
                        ...
                        ResponseType response = GtkDialog.CreateCustomDialog(
                            "OmniEMU - Low limit for memory mappings detected",
                            ...
                            "OmniEMU will crash as soon as this limit gets exceeded.",
                            buttonTexts,
                    ...
                    else
                    {
                        GtkDialog.CreateWarningDialog(
                            ...
                            "Some games might try to create more memory mappings than currently allowed. " +
                            "OmniEMU will crash as soon as this limit gets exceeded.\n\n" +
                            "You might want to either manually increase the limit or install pkexec, which allows OmniEMU to assist with that.");
                    }
                }
            }
        ...
        {
            Logger.Notice.Print(LogClass.Application, $"OmniEMU Version: {Version}");
