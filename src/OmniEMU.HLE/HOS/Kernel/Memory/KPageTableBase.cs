...
namespace OmniEMU.HLE.HOS.Kernel.Memory
{
    abstract class KPageTableBase
    {
        ...
        /// <exception cref="OmniEMU.Memory.InvalidMemoryRegionException">Throw for unhandled invalid or unmapped memory accesses</exception>
