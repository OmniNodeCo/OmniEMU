...
namespace OmniEMU.HLE.HOS.Applets.SoftwareKeyboard
{
    /// <summary>
    ...
    internal class SoftwareKeyboardRendererBase
    {
        ...
        private readonly SKBitmap _omniemuLogo = null;
        ...
        {
            int omniemuLogoSize = 32;

            string omniemuIconPath = "OmniEMU.HLE.HOS.Applets.SoftwareKeyboard.Resources.Logo_OmniEMU.png";
            _omniemuLogo = LoadResource(typeof(SoftwareKeyboardRendererBase).Assembly, omniemuIconPath, omniemuLogoSize, omniemuLogoSize);

            string padAcceptIconPath = "OmniEMU.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnA.png";
            string padCancelIconPath = "OmniEMU.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnB.png";
            string keyModeIconPath = "OmniEMU.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_KeyF6.png";
        ...
        private void DrawImmutableElements()
        {
            ...
            canvas.DrawBitmap(_omniemuLogo, _logoPosition);
        ...
        private void ComputeConstants()
        {
            ...
            int logoPositionX = (totalWidth - _omniemuLogo.Width) / 2;
