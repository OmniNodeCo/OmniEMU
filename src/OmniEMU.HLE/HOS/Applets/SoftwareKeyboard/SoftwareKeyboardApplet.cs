...
using OmniEMU.HLE.HOS.Applets.SoftwareKeyboard;
using OmniEMU.HLE.HOS.Services.Am.AppletAE;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.Npad;
using OmniEMU.HLE.UI;
using OmniEMU.HLE.UI.Input;
...
namespace OmniEMU.HLE.HOS.Applets
{
    internal class SoftwareKeyboardApplet : IApplet
    {
        private const string DefaultInputText = "OmniEMU";
