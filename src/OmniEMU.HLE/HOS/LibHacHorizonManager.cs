...
using OmniEMU.HLE.HOS.Services.Arp;
using System;
...
namespace OmniEMU.HLE.HOS
{
    public class LibHacHorizonManager
    {
        ...
        public HorizonClient OmniEMUClient { get; private set; }
        ...
        private void InitializeServer()
        {
            ...
            OmniEMUClient = Server.CreatePrivilegedHorizonClient();
        }

        public void InitializeArpServer()
        {
            _arpIReader.Reset(new LibHacIReader());
            OmniEMUClient.Sm.RegisterService(new LibHacArpServiceObject(ref _arpIReader), "arp:r").ThrowIfFailure();
        }
