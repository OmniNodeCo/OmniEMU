...
using OmniEMU.HLE.HOS.Services.Fs.FileSystemProxy;
using System;
using System.IO;
using static OmniEMU.HLE.Utilities.StringUtils;
using GameCardHandle = System.UInt32;
using IFileSystem = LibHac.FsSrv.Sf.IFileSystem;
using IStorage = LibHac.FsSrv.Sf.IStorage;

namespace OmniEMU.HLE.HOS.Services.Fs
{
    [Service("fsp-srv")]
...
#pragma warning restore IDE0059
        ...
        public ResultCode OutputAccessLogToSdCard(ServiceCtx context)
        {
            ...
            // FS ends each line with a newline. Remove it because OmniEMU logging adds its own newline
