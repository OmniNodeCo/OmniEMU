...
using OmniEMU.HLE.HOS.Services.Sockets.Sfdnsres.Proxy;
using OmniEMU.HLE.HOS.Services.Sockets.Sfdnsres.Types;
...
namespace OmniEMU.HLE.HOS.Services.Sockets.Sfdnsres
{
    [Service("sfdnsres")]
