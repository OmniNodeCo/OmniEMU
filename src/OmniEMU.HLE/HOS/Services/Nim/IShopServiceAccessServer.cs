...
using OmniEMU.HLE.HOS.Services.Nim.ShopServiceAccessServerInterface.ShopServiceAccessServer;

namespace OmniEMU.HLE.HOS.Services.Nim.ShopServiceAccessServerInterface
{
