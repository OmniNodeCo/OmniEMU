...
using System.IO;
using System.Text;
using TimeZoneRuleBox = OmniEMU.Common.Memory.Box<OmniEMU.HLE.HOS.Services.Time.TimeZone.TimeZoneRule>;

namespace OmniEMU.HLE.HOS.Services.Time.TimeZone
{
    public class TimeZoneContentManager
    {
        private const long TimeZoneBinaryTitleId = 0x010000000000080E;

        private const string TimeZoneSystemTitleMissingErrorMessage = "TimeZoneBinary system title not found! TimeZone conversions will not work, provide the system archive to fix this error. (See https://github.com/OmniNodeCo/OmniEMU#first-run for more information)";
