...
using OmniEMU.HLE.HOS.Services.Ssl.Types;
using System;
...
namespace OmniEMU.HLE.HOS.Services.Ssl
{
    class BuiltInCertificateManager
    {
        private const long CertStoreTitleId = 0x0100000000000800;

        private const string CertStoreTitleMissingErrorMessage = "CertStore system title not found! SSL CA retrieving will not work, provide the system archive to fix this error. (See https://github.com/OmniNodeCo/OmniEMU#first-run for more information)";
