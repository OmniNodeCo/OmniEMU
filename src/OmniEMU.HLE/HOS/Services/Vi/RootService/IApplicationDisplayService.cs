...
using OmniEMU.HLE.HOS.Services.Vi.RootService.ApplicationDisplayService;
using OmniEMU.HLE.HOS.Services.Vi.RootService.ApplicationDisplayService.Types;
using OmniEMU.HLE.HOS.Services.Vi.Types;
...
namespace OmniEMU.HLE.HOS.Services.Vi.RootService
{
