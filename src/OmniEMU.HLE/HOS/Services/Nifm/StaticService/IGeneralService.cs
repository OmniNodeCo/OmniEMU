...
using OmniEMU.HLE.HOS.Services.Nifm.StaticService.GeneralService;
using OmniEMU.HLE.HOS.Services.Nifm.StaticService.Types;
using System;
using System.Net.NetworkInformation;
using System.Runtime.CompilerServices;

namespace OmniEMU.HLE.HOS.Services.Nifm.StaticService
{
    class IGeneralService : DisposableIpcService
    {
        ...
        public ResultCode GetCurrentNetworkProfile(ServiceCtx context)
        {
            ...
            "OmniEMUNetwork"u8.CopyTo(networkProfile.Name.AsSpan());
