...
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.Common;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.DebugPad;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.Keyboard;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.Mouse;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.Npad;
using OmniEMU.HLE.HOS.Services.Hid.Types.SharedMemory.TouchScreen;
