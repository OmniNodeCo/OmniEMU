...
using OmniEMU.Graphics.Gpu.Synchronization;
using OmniEMU.HLE.HOS.Services.Nv.NvDrvServices.NvHostCtrl.Types;
...
namespace OmniEMU.HLE.HOS.Services.Nv.NvDrvServices.NvHostCtrl
{
