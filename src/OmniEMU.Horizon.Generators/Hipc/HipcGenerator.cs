...
namespace OmniEMU.Horizon.Generators.Hipc
{
    [Generator]
    class HipcGenerator : ISourceGenerator
    {
        ...
        private const string TypeResult = "OmniEMU.Horizon.Common.Result";
        private const string TypeBufferAttribute = "OmniEMU.Horizon.Sdk.Sf.BufferAttribute";
        private const string TypeCopyHandleAttribute = "OmniEMU.Horizon.Sdk.Sf.CopyHandleAttribute";
        private const string TypeMoveHandleAttribute = "OmniEMU.Horizon.Sdk.Sf.MoveHandleAttribute";
        private const string TypeClientProcessIdAttribute = "OmniEMU.Horizon.Sdk.Sf.ClientProcessIdAttribute";
        private const string TypeCommandAttribute = "OmniEMU.Horizon.Sdk.Sf." + CommandAttributeName;
        private const string TypeIServiceObject = "OmniEMU.Horizon.Sdk.Sf.IServiceObject";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var commandInterface in syntaxReceiver.CommandInterfaces)
            {
                ...
                generator.AppendLine("using OmniEMU.Horizon.Common;");
                generator.AppendLine("using OmniEMU.Horizon.Sdk.Sf;");
                generator.AppendLine("using OmniEMU.Horizon.Sdk.Sf.Cmif;");
                generator.AppendLine("using OmniEMU.Horizon.Sdk.Sf.Hipc;");
