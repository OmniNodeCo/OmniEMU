...
using System;
using Extent2D = OmniEMU.Graphics.GAL.Extents2D;
...
namespace OmniEMU.Graphics.Vulkan.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        public void Initialize()
        {
            ...
            var scalingShader = EmbeddedResources.Read("OmniEMU.Graphics.Vulkan/Effects/Shaders/FsrScaling.spv");
            var sharpeningShader = EmbeddedResources.Read("OmniEMU.Graphics.Vulkan/Effects/Shaders/FsrSharpening.spv");
