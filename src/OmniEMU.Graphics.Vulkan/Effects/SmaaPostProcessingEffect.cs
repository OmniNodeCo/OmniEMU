...
using System;
using Format = OmniEMU.Graphics.GAL.Format;
using SamplerCreateInfo = OmniEMU.Graphics.GAL.SamplerCreateInfo;

namespace OmniEMU.Graphics.Vulkan.Effects
{
    internal class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        private void RecreateShaders(int width, int height)
        {
            ...
            var edgeShader = EmbeddedResources.Read("OmniEMU.Graphics.Vulkan/Effects/Shaders/SmaaEdge.spv");
            var blendShader = EmbeddedResources.Read("OmniEMU.Graphics.Vulkan/Effects/Shaders/SmaaBlend.spv");
            var neighbourShader = EmbeddedResources.Read("OmniEMU.Graphics.Vulkan/Effects/Shaders/SmaaNeighbour.spv");
        ...
        private void Initialize()
        {
            ...
            var areaTexture = EmbeddedResources.ReadFileToRentedMemory("OmniEMU.Graphics.Vulkan/Effects/Textures/SmaaAreaTexture.bin");
            var searchTexture = EmbeddedResources.ReadFileToRentedMemory("OmniEMU.Graphics.Vulkan/Effects/Textures/SmaaSearchTexture.bin");
