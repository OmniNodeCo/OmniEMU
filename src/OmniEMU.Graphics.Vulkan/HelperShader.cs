...
using CompareOp = OmniEMU.Graphics.GAL.CompareOp;
using Format = OmniEMU.Graphics.GAL.Format;
using PrimitiveTopology = OmniEMU.Graphics.GAL.PrimitiveTopology;
using SamplerCreateInfo = OmniEMU.Graphics.GAL.SamplerCreateInfo;
using StencilOp = OmniEMU.Graphics.GAL.StencilOp;
using Viewport = OmniEMU.Graphics.GAL.Viewport;
...
namespace OmniEMU.Graphics.Vulkan
{
    ...
    class HelperShader : IDisposable
    {
        ...
        private const string ShaderBinariesPath = "OmniEMU.Graphics.Vulkan/Shaders/SpirvBinaries";
