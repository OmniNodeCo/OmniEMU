...
namespace OmniEMU.Horizon.Kernel.Generators
{
    [Generator]
    class SyscallGenerator : ISourceGenerator
    {
        private const string ClassNamespace = "OmniEMU.HLE.HOS.Kernel.SupervisorCall";
        ...
        private const string NamespaceKernel = "OmniEMU.HLE.HOS.Kernel";
        private const string NamespaceHorizonCommon = "OmniEMU.Horizon.Common";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            generator.AppendLine("using OmniEMU.Common.Logging;");
            generator.AppendLine("using OmniEMU.Cpu;");
