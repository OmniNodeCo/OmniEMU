...
using OmniEMU.HLE.HOS.Services.Hid;
using System.Linq;
using System.Threading.Tasks;

namespace OmniEMU.Ava.UI.Applet
{
    internal partial class ControllerAppletDialog : UserControl
    {
        private const string ProControllerResource = "OmniEMU/Assets/Icons/Controller_ProCon.svg";
        private const string JoyConPairResource = "OmniEMU/Assets/Icons/Controller_JoyConPair.svg";
        private const string JoyConLeftResource = "OmniEMU/Assets/Icons/Controller_JoyConLeft.svg";
        private const string JoyConRightResource = "OmniEMU/Assets/Icons/Controller_JoyConRight.svg";
