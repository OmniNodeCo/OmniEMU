...
namespace OmniEMU.Ava.UI.Windows
{
    public partial class MainWindow : StyleableWindow
    {
        ...
        public MainWindow()
        {
            ...
            ViewModel.Title = $"OmniEMU {Program.Version}";
        ...
        private void Initialize()
        {
            ...
            VirtualFileSystem.FixExtraData(LibHacHorizonManager.OmniEMUClient);

            AccountManager = new AccountManager(LibHacHorizonManager.OmniEMUClient, CommandLineState.Profile);

            VirtualFileSystem.ReloadKeySet();

            ApplicationHelper.Initialize(VirtualFileSystem, AccountManager, LibHacHorizonManager.OmniEMUClient);
        }
        ...
        private static async Task ShowVmMaxMapCountDialog()
        {
            ...
            UserResult response = await ContentDialogHelper.ShowTextDialog(
                $"OmniEMU - {LocaleManager.Instance[LocaleKeys.LinuxVmMaxMapCountDialogTitle]}",
