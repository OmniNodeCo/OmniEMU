...
using OmniEMU.Ava.UI.Models.Input;
...
namespace OmniEMU.Ava.UI.ViewModels.Input
{
    public class InputViewModel : BaseModel, IDisposable
    {
        private const string Disabled = "disabled";
        private const string ProControllerResource = "OmniEMU.UI.Common/Resources/Controller_ProCon.svg";
        private const string JoyConPairResource = "OmniEMU.UI.Common/Resources/Controller_JoyConPair.svg";
        private const string JoyConLeftResource = "OmniEMU.UI.Common/Resources/Controller_JoyConLeft.svg";
        private const string JoyConRightResource = "OmniEMU.UI.Common/Resources/Controller_JoyConRight.svg";
