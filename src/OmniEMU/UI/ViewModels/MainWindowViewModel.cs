...
using OmniEMU.Ava.UI.Models.Generic;
...
#pragma warning restore IDE0055
                    ...
                    Thread thread = new(() =>
                    {
                        ...
                        try
                        {
                            ...
                            Dispatcher.UIThread.InvokeAsync(async delegate
                            {
                                ...
                                await ContentDialogHelper.CreateInfoDialog(dialogTitle, message, LocaleManager.Instance[LocaleKeys.InputDialogOk], "", LocaleManager.Instance[LocaleKeys.OmniEMUInfo]);
            ...
            var result = await StorageProvider.OpenFilePickerAsync(new FilePickerOpenOptions
            {
                ...
                FileTypeFilter = new List<FilePickerFileType>
                {
                    new(LocaleManager.Instance[LocaleKeys.FileDialogAllTypes])
                    {
                        ...
                        AppleUniformTypeIdentifiers = new[] { "com.omniemu.xci", "public.zip-archive" },
                        MimeTypes = new[] { "application/x-nx-xci", "application/zip" },
                    },
                    new("XCI")
                    {
                        Patterns = new[] { "*.xci" },
                        AppleUniformTypeIdentifiers = new[] { "com.omniemu.xci" },
        ...
        {
            await NavigationDialogHost.Show(AccountManager, ContentManager, VirtualFileSystem, LibHacHorizonManager.OmniEMUClient);
        }
        ...
        public async Task OpenFile()
        {
            var result = await StorageProvider.OpenFilePickerAsync(new FilePickerOpenOptions
            {
                ...
                FileTypeFilter = new List<FilePickerFileType>
                {
                    ...
                    {
                        Patterns = new[] { "*.nsp" },
                        AppleUniformTypeIdentifiers = new[] { "com.omniemu.nsp" },
                    ...
                    {
                        Patterns = new[] { "*.nca" },
                        AppleUniformTypeIdentifiers = new[] { "com.omniemu.nca" },
                        MimeTypes = new[] { "application/x-nx-nca" },
                    },
                    new("NRO")
                    {
                        Patterns = new[] { "*.nro" },
                        AppleUniformTypeIdentifiers = new[] { "com.omniemu.nro" },
                        MimeTypes = new[] { "application/x-nx-nro" },
                    },
                    new("NSO")
                    {
                        Patterns = new[] { "*.nso" },
                        AppleUniformTypeIdentifiers = new[] { "com.omniemu.nso" },
