...
namespace OmniEMU.UI.Common.Helper
{
    public static partial class FileAssociationHelper
    {
        ...
        [SupportedOSPlatform("linux")]
        private static bool AreMimeTypesRegisteredLinux() => File.Exists(Path.Combine(_mimeDbPath, "packages", "OmniEMU.xml"));
        ...
        private static bool InstallLinuxMimeTypes(bool uninstall = false)
        {
            ...
            {
                string mimeTypesFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "mime", "OmniEMU.xml");
        ...
        private static bool AreMimeTypesRegisteredWindows()
        {
            static bool CheckRegistering(string ext)
            {
                ...
                return keyValue is not null && (keyValue.Contains("OmniEMU") || keyValue.Contains(AppDomain.CurrentDomain.FriendlyName));
            }
