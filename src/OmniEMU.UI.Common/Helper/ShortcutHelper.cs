...
namespace OmniEMU.UI.Common.Helper
{
    public static class ShortcutHelper
    {
        ...
        {
            string basePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "OmniEMU.sh");
            var desktopFile = EmbeddedResources.ReadAllText("OmniEMU.UI.Common/shortcut-template.desktop");
            iconPath += ".png";
        ...
        {
            string basePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "OmniEMU");
            var plistFile = EmbeddedResources.ReadAllText("OmniEMU.UI.Common/shortcut-template.plist");
            var shortcutScript = EmbeddedResources.ReadAllText("OmniEMU.UI.Common/shortcut-launch-script.sh");
            // Macos .App folder
        ...
        public static void CreateAppShortcut(string applicationFilePath, string applicationName, string applicationId, byte[] iconData)
        {
            ...
            {
                string iconPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".local", "share", "icons", "OmniEMU");
