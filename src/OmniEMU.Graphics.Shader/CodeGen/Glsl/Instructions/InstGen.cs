using OmniEMU.Graphics.Shader.IntermediateRepresentation;
using OmniEMU.Graphics.Shader.StructuredIr;
using OmniEMU.Graphics.Shader.Translation;
using System;
using System.Text;

using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenBallot;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenCall;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenFSI;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenHelper;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenMemory;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenPacking;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenShuffle;
using static OmniEMU.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenVector;
