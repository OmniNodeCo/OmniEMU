...
namespace OmniEMU.Graphics.OpenGL.Effects.Smaa
{
    internal partial class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        {
            string baseShader = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/smaa.hlsl");
            ...
            for (int i = 0; i < +_edgeShaderPrograms.Length; i++)
            {
                ...
                var edgeShaderData = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/smaa_edge.glsl");
                var blendShaderData = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/smaa_blend.glsl");
                var neighbourShaderData = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/smaa_neighbour.glsl");
        ...
        private void Initialize()
        {
            ...
            var areaTexture = EmbeddedResources.ReadFileToRentedMemory("OmniEMU.Graphics.OpenGL/Effects/Textures/SmaaAreaTexture.bin");
            var searchTexture = EmbeddedResources.ReadFileToRentedMemory("OmniEMU.Graphics.OpenGL/Effects/Textures/SmaaSearchTexture.bin");
