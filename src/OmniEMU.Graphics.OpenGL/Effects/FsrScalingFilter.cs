...
using System;
using static OmniEMU.Graphics.OpenGL.Effects.ShaderHelper;
...
namespace OmniEMU.Graphics.OpenGL.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        {
            var scalingShader = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/fsr_scaling.glsl");
            var sharpeningShader = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/fsr_sharpening.glsl");
            var fsrA = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/ffx_a.h");
            var fsr1 = EmbeddedResources.ReadAllText("OmniEMU.Graphics.OpenGL/Effects/Shaders/ffx_fsr1.h");
