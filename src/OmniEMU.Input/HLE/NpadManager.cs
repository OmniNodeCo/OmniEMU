...
using CemuHookClient = OmniEMU.Input.Motion.CemuHook.Client;
using ControllerType = OmniEMU.Common.Configuration.Hid.ControllerType;
using PlayerIndex = OmniEMU.HLE.HOS.Services.Hid.PlayerIndex;
using Switch = OmniEMU.HLE.Switch;

namespace OmniEMU.Input.HLE
{
