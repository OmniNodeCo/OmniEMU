using OmniEMU.Common.GraphicsDriver.NVAPI;
using System;
using System.Runtime.CompilerServices;
using System.Runtime.InteropServices;

namespace OmniEMU.Common.GraphicsDriver
{
    static partial class NVThreadedOptimization
    {
        private const string ProfileName = "OmniEMU Nvidia Profile";
        ...
        public static void SetThreadedOptimization(bool enabled)
        {
            ...
            if (status != 0)
            {
                ...
                application.AppName.Set("OmniEMU.exe");
                application.UserFriendlyName.Set("OmniEMU");
