using OmniEMU.Common.Logging.Formatters;
using System;
using System.IO;
using System.Linq;

namespace OmniEMU.Common.Logging.Targets
{
    public class FileLogTarget : ILogTarget
    {
        ...
        public static FileStream PrepareLogFile(string path)
        {
            ...
            path = Path.Combine(logDir.FullName, $"OmniEMU_{version}_{DateTime.Now:yyyy-MM-dd_HH-mm-ss}.log");
