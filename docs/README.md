...
This repo includes several documents that explain both high-level and low-level concepts about OmniEMU and its functions. These are very useful for contributors, to get context that can be very difficult to acquire from just reading code.

Intro to OmniEMU
==================

OmniEMU is an open-source Nintendo Switch emulator, created by gdkchan, written in C#.
